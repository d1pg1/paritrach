...
export const COMPETITIONS: CompetitionConfig[] = [
  ...
  { label: "UEFA Champions League", group: "cup", source: "oddspapi", oddsApiSportKey: "soccer_uefa_champs_league", oddsPapiTournamentId: 7, espnSlug: "uefa.champions" },
  { label: "UEFA Europa League", group: "cup", source: "oddspapi", oddsApiSportKey: "soccer_uefa_europa_league", oddsPapiTournamentId: 679, espnSlug: "uefa.europa" },
  { label: "UEFA Europa Conference League", group: "cup", source: "oddspapi", oddsApiSportKey: "soccer_uefa_europa_conference_league", oddsPapiTournamentId: 34480, espnSlug: "uefa.europa.conf" },
